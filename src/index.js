const STATIC_SECTORS = [
  {name:"Tecnología de la información", en:"Information Technology", etf:"XLK", weight:38.6, rating:"Neutral", pe:29.30, divYield:0.39, top3:45.6, top10:68.5, wamc:1657714.40, fallback:{price:179.18,ytd:24.46,sixM:24.17,oneY:39.46,range:[126.6,198.73]}, holdings:[["NVIDIA",12.83],["Apple",11.59],["Microsoft",7.65],["Broadcom",4.69],["AMD",4.51]], industries:[["Semiconductores",47.31],["Software",21.61],["Hardware tecnológico",17.89],["Equipos comunicación",5.60],["Equipo electrónico",4.78],["Servicios TI",2.80]]},
  {name:"Industriales", en:"Industrials", etf:"XLI", weight:8.3, rating:"Más favorecido", pe:27.23, divYield:0.98, top3:14.5, top10:29.5, wamc:158179.86, fallback:{price:182.38,ytd:17.57,sixM:15.44,oneY:22.06,range:[147.14,186.09]}, holdings:[["Caterpillar",8.02],["GE Aerospace",6.87],["GE Vernova",5.35],["RTX",4.53],["Boeing",3.02]], industries:[["Aeroespacial/defensa",25.82],["Maquinaria",21.43],["Equipo eléctrico",14.26],["Transporte terrestre",9.70],["Productos construcción",5.52]]},
  {name:"Energía", en:"Energy", etf:"XLE", weight:3.1, rating:"Neutral", pe:11.88, divYield:2.84, top3:43.2, top10:64.7, wamc:205599.69, fallback:{price:54.64,ytd:22.21,sixM:19.69,oneY:25.55,range:[42.05,63.46]}, holdings:[["Exxon Mobil",20.36],["Chevron",14.49],["ConocoPhillips",5.88],["Marathon Petroleum",4.66],["Valero Energy",4.61]], industries:[["Petróleo/gas/combustibles",89.89],["Equipos y servicios energía",10.11]]},
  {name:"Materiales", en:"Materials", etf:"XLB", weight:1.8, rating:"Más favorecido", pe:17.34, divYield:1.74, top3:27.5, top10:53.4, wamc:78347.88, fallback:{price:51.51,ytd:13.58,sixM:11.69,oneY:12.74,range:[42.04,54.14]}, holdings:[["Linde",14.42],["Newmont",5.82],["Freeport-McMoRan",5.09],["Sherwin-Williams",4.95],["Corteva",4.88]], industries:[["Químicos",52.48],["Metales y minería",18.33],["Envases y embalajes",15.33],["Materiales construcción",13.86]]},
  {name:"Bienes raíces", en:"Real Estate", etf:"XLRE", weight:1.8, rating:"Menos favorecido", pe:35.96, divYield:3.23, top3:23.8, top10:48.6, wamc:64667.20, fallback:{price:44.89,ytd:11.25,sixM:11.17,oneY:7.39,range:[39.73,45.65]}, holdings:[["Welltower",11.12],["Prologis",8.73],["Equinix",6.84],["American Tower",5.29],["Simon Property Group",4.95]], industries:[["REITs especializados",38.57],["REITs salud",18.08],["REITs retail",13.59],["REITs residenciales",12.98],["REITs industriales",8.76],["Gestión/desarrollo inmob.",5.44]]},
  {name:"Consumo básico", en:"Consumer Staples", etf:"XLP", weight:4.5, rating:"Neutral", pe:20.22, divYield:2.63, top3:45.4, top10:76.5, wamc:230834.72, fallback:{price:84.86,ytd:9.24,sixM:9.23,oneY:3.26,range:[75.16,90.14]}, holdings:[["Walmart",10.36],["Costco",8.91],["Procter & Gamble",7.45],["Coca-Cola",6.83],["Philip Morris",6.01]], industries:[["Distribución/retail básico",32.81],["Bebidas",20.77],["Productos hogar",16.90],["Alimentos",15.23],["Tabaco",10.55],["Cuidado personal",3.74]]},
  {name:"Servicios públicos", en:"Utilities", etf:"XLU", weight:2.1, rating:"Menos favorecido", pe:18.61, divYield:2.67, top3:24.0, top10:52.0, wamc:70597.19, fallback:{price:45.7,ytd:7.05,sixM:5.84,oneY:11.68,range:[40.17,47.8]}, holdings:[["NextEra Energy",12.85],["Southern",7.65],["Duke Energy",6.99],["Constellation Energy",5.39],["American Electric Power",5.24]], industries:[["Eléctricas",65.03],["Multi-utilities",26.84],["IPP/renovables",4.22],["Gas utilities",2.07],["Agua utilities",1.84]]},
  {name:"Salud", en:"Health Care", etf:"XLV", weight:8.3, rating:"Más favorecido", pe:19.09, divYield:1.59, top3:28.8, top10:49.9, wamc:371254.25, fallback:{price:164.44,ytd:6.23,sixM:5.74,oneY:21.36,range:[127.96,164.44]}, holdings:[["Eli Lilly",16.34],["Johnson & Johnson",10.59],["AbbVie",7.69],["UnitedHealth",6.71],["Merck",5.37]], industries:[["Farmacéuticas",37.59],["Servicios/proveedores salud",19.14],["Biotecnología",18.40],["Equipos salud",15.57],["Life sciences tools",8.83],["Tecnología salud",0.48]]},
  {name:"Servicios de comunicación", en:"Communication Services", etf:"XLC", weight:10.4, rating:"Más favorecido", pe:14.28, divYield:1.15, top3:83.3, top10:93.6, wamc:1200550.00, fallback:{price:111.02,ytd:-5.69,sixM:-5.03,oneY:2.76,range:[105.03,120.41]}, holdings:[["Meta Platforms A",17.97],["Alphabet A",10.97],["Alphabet C",8.76],["Take-Two Interactive",4.48],["Live Nation",4.46]], industries:[["Interactive media",37.76],["Entertainment",28.88],["Media",16.22],["Telecom diversificada",12.73],["Telecom inalámbrica",4.41]]},
  {name:"Consumo discrecional", en:"Consumer Discretionary", etf:"XLY", weight:9.7, rating:"Menos favorecido", pe:26.04, divYield:0.76, top3:56.5, top10:68.6, wamc:963934.50, fallback:{price:117.39,ytd:-1.69,sixM:-0.81,oneY:6.13,range:[105.19,125.01]}, holdings:[["Amazon",22.39],["Tesla",19.74],["Home Depot",5.76],["McDonald's",4.11],["TJX Companies",3.89]], industries:[["Hoteles/rest./ocio",25.26],["Retail amplio",23.64],["Automóviles",22.76],["Retail especializado",20.79],["Bienes durables hogar",3.52],["Textiles/lujo",3.03]]},
  {name:"Financieros", en:"Financials", etf:"XLF", weight:11.3, rating:"Neutral", pe:16.09, divYield:1.37, top3:25.7, top10:48.1, wamc:405489.25, fallback:{price:56.05,ytd:2.34,sixM:2.04,oneY:5.38,range:[47.67,56.52]}, holdings:[["Berkshire Hathaway B",11.83],["JPMorgan Chase",11.56],["Visa A",7.52],["Mastercard A",5.44],["Bank of America",4.92]], industries:[["Bancos",28.98],["Servicios financieros",27.84],["Mercados de capitales",25.29],["Seguros",13.52],["Crédito consumo",4.38]]}
];

const MARKET_PILLS = [
  { label: "S&P 500 / SPY", symbol: "SPY", sub: "proxy ETF", fallback: { price: 747.71, ytd: 9.65, asOf: "2026-07-07" } },
  { label: "NASDAQ 100 / QQQ", symbol: "QQQ", sub: "proxy ETF", fallback: { price: 712.22, ytd: 16.27, asOf: "2026-07-09" } },
  { label: "Russell 2000 / IWM", symbol: "IWM", sub: "proxy ETF", fallback: { price: 295.52, ytd: 21.39, asOf: "2026-07-07" } }
];
...
function applyDynamicData(quotes) {
  ...
  const sectors = STATIC_SECTORS.map(sector => {
    ...
    return {
      ...
      asOf: dynamicOk ? quote.asOf : "2026-07-07",
      marketSource: dynamicOk ? quote.source : "fallback estático (snapshot 07-jul-2026)",
      marketError: quote?.error || null
    };
  });
  const pills = MARKET_PILLS.map(item => {
    const quote = quoteMap.get(item.symbol);
    const ok = quote && !quote.error && Number.isFinite(quote.price);
    const { fallback, ...rest } = item;
    return {
      ...rest,
      price: ok ? quote.price : fallback.price,
      ytd: ok ? quote.ytd : fallback.ytd,
      asOf: ok ? quote.asOf : fallback.asOf,
      source: ok ? quote.source : "fallback estático (snapshot 07-jul-2026)",
